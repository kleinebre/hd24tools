#include <FL/Fl_Image_Repeat_Button.H>
...
#define NULL 0
#endif
void Fl_Image_Repeat_Button::up_image(Fl_Image* p_upimage)
{
	upimage=p_upimage;
}

void Fl_Image_Repeat_Button::down_image(Fl_Image* p_downimage)
{
	downimage=p_downimage;
}

Fl_Image* Fl_Image_Repeat_Button::up_image()
{
	return upimage;
}

Fl_Image* Fl_Image_Repeat_Button::down_image()
{
	return downimage;
}

Fl_Image_Repeat_Button::Fl_Image_Repeat_Button(int a,int b,int c,int d):Fl_Repeat_Button(a,b,c,d)
{
	upimage=NULL;
	downimage=NULL;
	Fl_Repeat_Button::clear_visible_focus();
}


void Fl_Image_Repeat_Button::draw()
{
